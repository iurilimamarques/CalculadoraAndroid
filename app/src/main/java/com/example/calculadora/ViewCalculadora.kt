...
@Composable
fun NumeroButton(acao: () -> Unit, numero: String) {
    Button(onClick = acao,
...
@Composable
fun AcaoButton(acao: () -> Unit, operador: String, greyButton: Boolean) {
...
fun Calculadora(operacao: Operacao) {
    Column (modifier = Modifier.fillMaxSize().background(Color(0xFF000000)),
        ...
        Row (modifier = Modifier.background(Color(0xFF000000)).fillMaxWidth(),
            ...
            AcaoButton(acao = {operacao.addOperacao("*")}, operador = "x", false)
        }
        ...
        Row (modifier = Modifier.background(Color(0xFF000000)).fillMaxWidth(),
            horizontalArrangement = Arrangement.SpaceEvenly) {
            NumeroButton(acao = {operacao.addNumero("0")}, numero = "0")
            NumeroButton(acao = {operacao.addNumero(",")}, numero = ",")
            AcaoButton(acao = {operacao.calculaResultado()}, operador = "=", false)
        }
    }
}
